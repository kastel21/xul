...
class RegAddForm(forms.ModelForm):
    ...
    is_reg = forms.BooleanField(label = " Registered", required=False)
    ...
    class Meta:
        model = Reg
        fields = ['owner','institute','comments']
    ...
    def save(self, commit=True):
        ...
        record.is_reg = self.cleaned_data.get('is_reg')
        record.institute = self.cleaned_data.get('institute')
        record.comments = self.cleaned_data.get('comments')
...
class CourseAllocationForm(forms.ModelForm):
    courses = forms.ModelMultipleChoiceField(
        queryset=Course.objects.all().order_by('courseTitle'),
